...
__TABLECOLUMNS_TYPE_ARRAY__
	...
	/**__TRANSFORM_TEXT_TO_KEY_SEARCH__**/
    ...
    foreach($table_columns as $col){
		...
		$whereClause =  $whereClause . "   __TABLENAME__.".$col . " LIKE '%". $searchValue ."%' ".$transform_text_to_key;
...
__TABLECOLUMNS_ARRAY__
	...
	foreach ($table_columns as $col){
		//var_dump($col) ;die;
		//array_push($tr_table_columns,$app['translator']->trans("__TABLENAME__".$col));
