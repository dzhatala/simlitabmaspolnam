...
/****** Admin Email ******/
$admEmail = 'dzulqarnaenhatala@gmail.com';
...
$languageFile = 'lng_indonesian.php';
...
$cfgServerUser = 'joesmart';                  // MySQL user
$cfgServerPassword = '156354';                  // MySQL password
...
$cfgDbDatabase = 'simlitabmas';        // MySQL database name containing phpSecurePages table
$cfgDbTableUsers = 'userlogin';         // MySQL table name containing phpSecurePages user fields
...
$cfgUserLevel[1] = '';                    // user level
  ...
  // Leave empty if authorization levels are not used.
  // See readme.txt for more info.
$cfgUserID[1] = 'admin';                       // user identification
  // enter a distinct ID if you want to be able to identify the current user
  // Leave empty if no ID is necessary.
  // See readme.txt for more info.
