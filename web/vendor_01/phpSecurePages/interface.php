...
<!-- Place your logo here -->
        <P><IMG width="150" SRC="<?php echo $cfgIndexpage ?>/resources/img/logobiru01.jpg"  ALT="phpSecurePages logo"></P>
<!-- Place your logo here -->
...
?>
    ...
    <div>
            <label for="login_username">User/NIP</label> 
    ...
    <div class="submit">
        <button type="submit"><?php echo $strLogin?></button>
...
<!-- ------ Copyright line starts here ------
        ...
        less (or un-) readable). -->
        <p><?php echo $strPoweredBy; ?> :<br>
	
		<IMG width="75" SRC="<?php echo $cfgIndexpage ?>/resources/img/apache_logo.jpg"  ALT="phpSecurePages logo">
		<IMG width="75" SRC="<?php echo $cfgIndexpage ?>/resources/img/php_logo.jpg"  ALT="phpSecurePages logo">
		<IMG width="75" SRC="<?php echo $cfgIndexpage ?>/resources/img/symfony_logo.png	"  ALT="phpSecurePages logo">
		<!--<A HREF="http://www.phpSecurePages.com" TITLE="phpSecurePages <?php echo $strInfo; ?>" TARGET="_blank" CLASS="link">phpSecurePages</A></p>-->
